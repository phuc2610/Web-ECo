...
const LatestCollection = () => {
  ...
  useEffect(() => {
    // Get latest 10 products and best seller 10 products, total 20
    ...
    const combinedProducts = [...latestProducts, ...bestSellerProducts];
  ...
  return (
    <div className='my-10'>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 gap-y-10 overflow-hidden'>
